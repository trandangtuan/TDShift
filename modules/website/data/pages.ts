...
export const pageData: DataRecordDefinition[] = [
  {
    ...
    values: {
      ...
      title: "MetaFlow",
      meta_description: "MetaFlow là ứng dụng quản trị doanh nghiệp có thể tải về, chỉnh sửa và mở rộng với CRM, bán hàng, mua hàng, kho, kế toán, website, tệp tin và AI.",
  ...
  },
  {
    ...
    values: {
      ...
      title: "Tính năng",
      meta_description: "Giới thiệu chi tiết các tính năng hiện có của ứng dụng quản trị dữ liệu, CRM, bán hàng, mua hàng, kho, website và trợ lý AI.",

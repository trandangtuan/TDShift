...
export const crmConfigData: DataRecordDefinition[] = [
  { externalId: "crm.team_direct_sales", model: "crm.team", values: { name: "Direct Bán hàng", email_alias: "sales", target_revenue: 500000000, sequence: 10, active: true } },
  ...
  { externalId: "crm.stage_won", model: "crm.stage", values: { name: "Thắng", sequence: 90, probability: 100, stage_type: "won", fold: true, active: true } },
  { externalId: "crm.stage_lost", model: "crm.stage", values: { name: "Đã mất", sequence: 100, probability: 0, stage_type: "lost", fold: true, active: true } },
  ...
  { externalId: "crm.activity_type_call", model: "crm.activity.type", values: { name: "Gọi điện", category: "call", default_delay_days: 0, active: true } },
  ...
  { externalId: "crm.activity_type_meeting", model: "crm.activity.type", values: { name: "Cuộc họp", category: "meeting", default_delay_days: 3, active: true } },
  ...
  { externalId: "crm.medium_phone", model: "crm.medium", values: { name: "Điện thoại", active: true } },
  ...
  { externalId: "crm.lost_reason_no_budget", model: "crm.lost.reason", values: { name: "Không Budget", description: "Customer does not have budget in this period.", active: true } },

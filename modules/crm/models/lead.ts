...
export const crmLeadModel: ModelDefinition = {
  ...
  fields: [
    ...
    { name: "type", label: "Type", type: "selection", defaultValue: "lead", selectionOptions: [{ label: "Lead", value: "lead" }, { label: "Opportunity", value: "opportunity" }], sequence: 20 },
    { name: "partner_id", label: "Customer", type: "many2one", relationModel: "res.partner", sequence: 30 },
    { name: "contact_name", label: "Contact Name", type: "char", sequence: 40 },
    { name: "email_from", label: "Email", type: "char", sequence: 50 },
    { name: "phone", label: "Phone", type: "char", sequence: 60 },
    { name: "company_name", label: "Company", type: "char", sequence: 70 },
    { name: "team_id", label: "Sales Team", type: "many2one", relationModel: "crm.team", sequence: 80 },
    { name: "user_id", label: "Salesperson", type: "many2one", relationModel: "core.user", sequence: 90 },
    ...
    { name: "expected_revenue", label: "Expected Revenue", type: "decimal", defaultValue: 0, sequence: 150 },
    { name: "probability", label: "Probability %", type: "decimal", defaultValue: 10, sequence: 160 },
    { name: "expected_closing", label: "Expected Closing", type: "date", sequence: 170 },
    { name: "priority", label: "Priority", type: "selection", defaultValue: "1", selectionOptions: [{ label: "Low", value: "0" }, { label: "Normal", value: "1" }, { label: "High", value: "2" }, { label: "Very High", value: "3" }], sequence: 180 },
    { name: "state", label: "State", type: "selection", defaultValue: "new", selectionOptions: [{ label: "New", value: "new" }, { label: "Qualified", value: "qualified" }, { label: "Proposition", value: "proposition" }, { label: "Won", value: "won" }, { label: "Lost", value: "lost" }], sequence: 190 },
    ...
    { name: "description", label: "Internal Notes", type: "text", sequence: 220 },
    { name: "activity_ids", label: "Activities", type: "one2many", relationModel: "crm.activity", inverseField: "lead_id", stored: false, sequence: 230 },
    ...
    { name: "active", label: "Active", type: "boolean", defaultValue: true, sequence: 250 }
  ],
  methods: {
    async convert(ctx) {

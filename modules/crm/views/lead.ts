...
export const crmLeadViews: ViewDefinition[] = [
    ...
    architecture: {
      ...
      children: [
        ...
        },
        {
          type: "notebook",
          children: [
            { type: "page", label: "Activities", children: [{ type: "group", children: [{ type: "field", name: "activity_ids" }] }] },
            ...
            { type: "page", label: "Lost", children: [{ type: "group", children: [{ type: "field", name: "lost_reason_id" }, { type: "field", name: "lost_feedback" }] }] },
            { type: "page", label: "Notes", children: [{ type: "group", children: [{ type: "field", name: "description" }] }] }
          ]
        }
      ]
    }

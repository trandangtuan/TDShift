...
export const journalData: DataRecordDefinition[] = [
  ...
  { externalId: "account.journal_sales", model: "account.journal", values: { code: "SAL", name: "Bán hàng Journal", type: "sale", active: true } },
  { externalId: "account.journal_purchase", model: "account.journal", values: { code: "PUR", name: "Mua hàng Journal", type: "purchase", active: true } },

...
export const productData: DataRecordDefinition[] = [
  ...
  { externalId: "product.product_sales_training", model: "product.product", values: { name: "Sales Team Training", default_code: "SERV-004", list_price: 650, active: true } },
  { externalId: "product.product_inventory_audit", model: "product.product", values: { name: "Inventory Audit", default_code: "SERV-005", list_price: 920, active: true } },
  ...
  { externalId: "product.product_priority_support", model: "product.product", values: { name: "Priority Support", default_code: "SERV-009", list_price: 420, active: true } },

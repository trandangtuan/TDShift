...
export const menuViews: ViewDefinition[] = [
  { technicalName: "base.menu.list", name: "Menus", model: "core.menu", type: "list", architecture: { type: "list", model: "core.menu", fields: ["technical_name", "name", "parent", "action", "icon", "sequence"] } },
  {

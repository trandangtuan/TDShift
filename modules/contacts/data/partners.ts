...
export const partnerData: DataRecordDefinition[] = [
  ...
  { externalId: "contacts.partner_orbit", model: "res.partner", values: { name: "Orbit Manufacturing", email: "ops@orbit.example", phone: "+1 555 0107", active: true } },
  { externalId: "contacts.partner_harbor", model: "res.partner", values: { name: "Harbor Logistics", email: "dispatch@harbor.example", phone: "+1 555 0108", active: true } },
  { externalId: "contacts.partner_lumen", model: "res.partner", values: { name: "Lumen Studio", email: "studio@lumen.example", phone: "+1 555 0109", active: true } },
  { externalId: "contacts.partner_crest", model: "res.partner", values: { name: "Crest Foods", email: "buying@crest.example", phone: "+1 555 0110", active: true } },
  { externalId: "contacts.partner_pioneer", model: "res.partner", values: { name: "Pioneer Services", email: "service@pioneer.example", phone: "+1 555 0111", active: true } },
  { externalId: "contacts.partner_silverline", model: "res.partner", values: { name: "Silverline Group", email: "info@silverline.example", phone: "+1 555 0112", active: true } },
  ...
  { externalId: "contacts.partner_cobalt", model: "res.partner", values: { name: "Cobalt Analytics", email: "data@cobalt.example", phone: "+1 555 0120", active: true } },
  { externalId: "contacts.partner_evergreen", model: "res.partner", values: { name: "Evergreen Design", email: "design@evergreen.example", phone: "+1 555 0121", active: true } },
  { externalId: "contacts.partner_zenith", model: "res.partner", values: { name: "Zenith Consulting", email: "consulting@zenith.example", phone: "+1 555 0122", active: true } }
];

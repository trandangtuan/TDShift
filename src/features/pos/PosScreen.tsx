...
import type { InventoryOperation, PosCartLine, PosCatalogProduct, PosContext } from "./types";
import { InventoryScanModal } from "./components/InventoryScanModal";
import { PosCartModal } from "./components/PosCartModal";
import { PosInventoryActions } from "./components/PosInventoryActions";
...
export function PosScreen({ env }: { env: Environment }) {
  ...
  const [inventoryOperation, setInventoryOperation] = useState<InventoryOperation | null>(null);
